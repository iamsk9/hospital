  ...
  while($row=mysqli_fetch_array($query))
  {
    ...
    <body>
      ...
      <div id="div1">
        <table width="100%">
          <tr>
            <td><strong><label>OP No:</label></strong></td>
            <td   colspan="3"><?php echo $row['id'].'/'.date('Y');?></td>
          ...
          <tr>
            ...
            <td colspan="3"><?php  echo $row['age'].'/'.$row['gender']; ?></td>
    ...
    <div id="div1">
     ...
     <table>
       <tr>
         <td><input type="submit" id="printbutton" name="print" value="print" onclick="Myprint()"/></td>
       </tr>
     </table>
   </body>
   </html>
